...
void Init(App* app)
{
	...
	glGenBuffers(1, &app->vao);
	glBindBuffer(GL_ARRAY_BUFFER, app->vao);
	...
	glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, sizeof(VertexV3V2), (void*)(sizeof(float) * 3));
...
void Render(App* app)
{
	...
	case Mode_TexturedQuad:
	{
		...
		Program& shader = app->programs[app->texturedGeometryProgramIdx];
